...
public class SingleDateAndTimePicker extends LinearLayout {
    ...
    private static final int PM_HOUR_ADDITION = 24;
    ...
    private static final CharSequence FORMAT_24_HOUR = "mm:H MMM d EEE";
    private static final CharSequence FORMAT_12_HOUR = "a mm:H MMM d EEE";
...
//        amPmPicker.setVisibility((isAmPm && displayHours) ? VISIBLE : GONE);
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        setSelectedTextColor(a.getColor(R.styleable.SingleDateAndTimePicker_picker_selectedTextColor, ContextCompat.getColor(context, R.color.color_003515)));
        ...
        if (android.os.Build.VERSION.SDK_INT >= android.os.Build.VERSION_CODES.O) {
            Typeface typeface = a.getResources().getFont(R.font.sf_pro_display_600);
